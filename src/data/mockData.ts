...
export const DEFAULT_PRICE_TABLES: PriceTable[] = [
  ...
  { id: 'postal-saude', name: 'Postal Saúde', description: 'Tabela Praticada Convênio Postal Saúde' },
  { id: 'geap', name: 'GEAP', description: 'Tabela Praticada Convênio GEAP Saúde' },
  { id: 'prevident', name: 'Prevident', description: 'Tabela Praticada Convênio Prevident Odontológico' },
  { id: 'wdental', name: 'WDental', description: 'Tabela Praticada Convênio WDental' },
